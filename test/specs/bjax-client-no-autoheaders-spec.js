...
module.exports = function() {
  describe('bjax-no-autoheaders', function() {

    it('should perform a GET', function() {
      return bjax(this.baseUrl + '/test/ping-cors-limited', { method: 'get', autoHeaders: false })
    ...
    it('should perform a POST', function() {
      return bjax(this.baseUrl + '/test/ping-cors-limited', { method: 'post', body: { hello: 1 }, autoHeaders: false })
        .then(function(response) {
